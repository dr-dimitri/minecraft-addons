...
- Die Datei **`Lumen-Silent-Birds-0.2.2.mcaddon`**. Sie enthält alles, was Minecraft für die Erweiterung benötigt.
...
2. Öffne im Windows-Explorer den Ordner mit `Lumen-Silent-Birds-0.2.2.mcaddon`.
